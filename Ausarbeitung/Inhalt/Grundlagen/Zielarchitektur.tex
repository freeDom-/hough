...
\\
\\
Der rekonfigurierbare Teil besteht aus einem Zynq UltraScale XCZU9EG-2FFVB1156 FPGA mit 600 logischen Einheiten, 32,1 Mb $\equiv$ 4 MB Speicher in Form von \ac{BRAM}, 2.520 \acp{DSP} und 328 I/O Pins. Dem FPGA stehen 512 MB DDR4 \ac{RAM} bei 1.200 MHz / 2.400 Mbps zur Verfügung.
\\
...
\\
\\
Die Zielarchitektur wird in \autoref{img:zielarchitektur} in einem Blockschaltbild dargestellt.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{Bilder/zynq-zcu102ug.pdf}
	\caption[Zynq Ultrascale+ MPSoC Block Diagramm]{ZynQ UltraScale+ MPSoC Bock Diagramm\\\cite[S. 21]{zcu102ug}}
	\label{img:zielarchitektur}
\end{figure}
