...
\begin{figure}[htb]
	...
	\begin{subfigure}{.5\textwidth}
		...
		\caption[Eingabebild des Grayscalers]{Eingabebild des Grayscalers\\Quelle: http://www.historia-hamburg.de/media/product/1ec/19-x-1-euro-satz-aus-19-euro-staaten-511.jpg}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
