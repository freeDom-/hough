...
\\
\\
Das Pipelining von Schleifen wurde bereits in \autoref{sec:pipelining} beschrieben. Pipelining ist jedoch nicht immer möglich. Als Voraussetzung für das Pipelining einer Schleife, die eine oder mehrere innere Schleifen enthält, ist es vorher notwendig, alle inneren Schleifen zu unrollen. Wenn diese nicht unrolled werden können, kann auch die äußere Schleife nicht gepipelined werden.
\\
