...
\begin{figure}[htb]
	...
	\caption{Timing der Implementierung des Grayscalermodul bei einem 400x400 Pixel großen Bild}
	\label{img:implementierung_timing_grayscaler400x400}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{Ressourcenaufwand der Implementierung des Grayscalermodul bei einem 400x400 Pixel großen Bild}
